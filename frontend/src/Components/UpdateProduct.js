...
const UpdateProduct = () => {
    ...
    return (
        <>
            <div>
                <h2 className="phead">Update Articles</h2>
                <div className="pbox">
                    ...
                    <input type="text" placeholder="Enter Aricle Description" className="probox" 
                     value={price} onChange={(e)=>{
                        setPrice(e.target.value);
                    }}
                    />
                    {error && !price && <span className="invalid-input">Invalid Price</span>}
                    <input type="text" placeholder="Enter Article Category" className="probox" 
                     value={category} onChange={(e)=>{
                        setCategory(e.target.value);
                    }}
                    />
                    {error && !category && <span className="invalid-input">Invalid Category</span>}
                    <input type="text" placeholder="Enter Article Company" className="probox" 
